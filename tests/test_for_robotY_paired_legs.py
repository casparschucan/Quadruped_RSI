...
class Quadruped(gym.Env): 
    ...
    def step(self, action):
        ...
        p.setJointMotorControl2(self.robotId, 8,
                                p.POSITION_CONTROL, targetPosition=action[3],
                                maxVelocity=5.23, targetVelocity=5.23
        )
        p.setJointMotorControl2(self.robotId, 11,
                                p.POSITION_CONTROL, targetPosition=action[2],
                                maxVelocity=5.23, targetVelocity=5.23
        )
        p.setJointMotorControl2(self.robotId, 13,
                                p.POSITION_CONTROL, targetPosition=action[3],
                                maxVelocity=5.23, targetVelocity=5.23
        )
        p.setJointMotorControl2(self.robotId, 16,
                                p.POSITION_CONTROL, targetPosition=action[0],
                                maxVelocity=5.23, targetVelocity=5.23
        )
        p.setJointMotorControl2(self.robotId, 18,
                                p.POSITION_CONTROL, targetPosition=action[1],
                                maxVelocity=5.23, targetVelocity=5.23
        )
        p.stepSimulation()
    ...
    def reset(self, gravity):
        ...
        self.robotId = p.loadURDF("/Users/caspa/VSCode/RSI_code/caspar2/robot.urdf", [0, 0, 0.15])
...
model = SAC.load("/Users/caspa/VSCode/RSI_code/maxVelo_symetric_diagonal_bigNN_relu_5,23_600_0,5")
